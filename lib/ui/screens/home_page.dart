...
num get fundingAmount=> num.tryParse(amountController.text)??0;
  ...
  void didChangeDependencies(){
    ...
    print(authProvider.session?.userId);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(backgroundColor: Colors.grey,
      appBar: AppBar(
        actions: [IconButton(onPressed: authProvider.logout, icon: Icon(Icons.logout))],
            ...
            child: Container(
              child: Column(
                ...
                children: <Widget>[
                 ...
                 ValueListenableBuilder(valueListenable: WalletProvider.
                 instance.balance,builder:(__,_,w)=>Text(_.toString(),
                      ...
                      Padding(padding: EdgeInsets.only(bottom: 10),
                          child: ElevatedButton(
                            onPressed:(){
                              ...
                              PaymentService.instance.fundWalletWithPaystack(
                                  context, fundingAmount, authProvider.session!.email!,
                                  (Random().nextInt(999999)*999999).toString()).then((result)  {

                                    if (result.status){
                                      WalletProvider.instance.fund(result.reference!, fundingAmount);
                                    }
                              });
                            } ,child:
                          Text("Fund Wallet"),)),
